...
<footer>
      <div class="flex_foot">
        <div class="shoping bottom_margin">
          <!-- shoping catagories  -->
          <h3 class="pink">ONLINE SHOPPING</h3>
        ...
        <div class="policies bottom_margin">
          <h3 class="pink">CUSTOMER POLICES</h3>
          <ul>
        ...
        <div class="footer_top bottom_margin">
          <h3 class="pink">KEEP IN TOUCH</h3>
      ...
      <div class="popular_searches bottom_margin">
        ...
        <div class="copywrite">
          ...
          <!-- copyrights      -->
          <p>&copy; copyright @ <?php echo date('Y'); ?> <?php echo date('M'); ?> by <span> Nitinkumar_7 </span> www.myntra.com. All rights reserved.</p>
        </div>
